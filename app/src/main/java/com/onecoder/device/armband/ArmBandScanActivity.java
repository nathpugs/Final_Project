...
public class ArmBandScanActivity extends BaseActivity implements BleScanCallBack,
    ...
    private String TAG = ArmBandScanActivity.class.getCanonicalName();
    ...
    private DeviceStateChangeCallback stateChangeCallback = new DeviceStateChangeCallback() {
        ...
        public void onStateChange(String mac, int status) {
            ...
            if (!hasStartDataPage && status == BleDevice.STATE_SERVICES_OPENCHANNELSUCCESS) {
                Intent intent = new Intent(ArmBandScanActivity.this, ArmBandMainActivity.class);
        ...
        public void onEnableWriteToDevice(String mac, boolean isNeedSetParam) {
            ...
            // 设置用户信息
            //  armBandManager.setUserBodyInfo();
            // 设置闹钟
            //  armBandManager.setAlarmPlan();
        }
    };
