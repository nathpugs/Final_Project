...
public class KettleBellScanActivity extends BaseActivity implements BleScanCallBack,
    ...
    private String TAG = KettleBellScanActivity.class.getCanonicalName();
    ...
    protected BleScanner getBleScanner() {
        ...
        //scanner.addNameFilter(DeviceType.KettleBell, new String[]{"KB"});
        return scanner;
    }
    ...
    public void onItemClick(BluetoothBean device) {
        ...
        //设置设备类型
        baseDevice.setDeviceType(DeviceType.KettleBell);
...
//            kettleBellManager.refreshDeviceCache();
        }
    }
    ...
    private DeviceStateChangeCallback stateChangeCallback = new DeviceStateChangeCallback() {
        ...
        public void onStateChange(String mac, int status) {
            ...
            if (!hasStartDataPage && status == BleDevice.STATE_SERVICES_OPENCHANNELSUCCESS) {
                Intent intent = new Intent(KettleBellScanActivity.this, KettleBellMainActivity.class);
